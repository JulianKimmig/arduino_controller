...
class PythonVariableTemplate(ModuleVariableTemplate):
    ...
    def __init__(self, name, type=np.float, html_input=None, python_variable_struc=None, save=True, getter=None,
                 setter=None, default=None, minimum=None, maximum=None, is_data_point=False, allowed_values=None,
                 nullable=True, changeable=None,unique=False):
        super().__init__(name=name,
                         ...
                         allowed_values=allowed_values,
                         nullable=nullable,
                         changeable=changeable,unique=unique)
        self.type=type
